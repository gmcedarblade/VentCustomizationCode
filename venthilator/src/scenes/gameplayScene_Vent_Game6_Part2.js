var GamePlayScene = function(game, stage, args)
{
  ...
  default values
  */
  var in_volume   = localStorage.getItem("ventPlayerSet") ? object.volume:.500;
  ...
  var in_flow     = localStorage.getItem("ventPlayerSet") ? object.flow:40;
  ...
  var in_peep     = localStorage.getItem("ventPlayerSet") ? object.peep:10;
  
  // Start of setting min and max display values for alarms
  
  var norm_in_alarm_min_pressure             = mapVal(min_in_alarm_pressure,             max_in_alarm_pressure,             0,1, localStorage.getItem("alarmPlayerSet") ? alarmParse.minPressureAlarm:20);
  var norm_in_alarm_max_pressure             = mapVal(min_in_alarm_pressure,             max_in_alarm_pressure,             0,1, localStorage.getItem("alarmPlayerSet") ? alarmParse.maxPressureAlarm:30);
  ...
  var norm_in_alarm_min_exhale_minute_volume = mapVal(min_in_alarm_exhale_minute_volume, max_in_alarm_exhale_minute_volume, 0,1, localStorage.getItem("alarmPlayerSet") ? alarmParse.minFlowAlarm:4);
  var norm_in_alarm_max_exhale_minute_volume = mapVal(min_in_alarm_exhale_minute_volume, max_in_alarm_exhale_minute_volume, 0,1, localStorage.getItem("alarmPlayerSet") ? alarmParse.maxFlowAlarm:14);
  ...
  var evaluate_patient = function()
  {
    ...
    if(fdisp(in_volume, 3) < 0.500 || fdisp(in_volume, 3) > 0.600) { console.log("vol");  return false; }
    if(fdisp(in_rate, 1) < 11.5 || fdisp(in_rate,1) > 16.5) { console.log("rate");  return false; }
    if(fdisp(in_peep, 1) < 10 || fdisp(in_peep,1) > 10) { console.log("peep"); return false; }
    if(fdisp(in_oxy, 2) < 49.5 || fdisp(in_oxy, 2) > 70.5) { console.log("oxy");  return false; }
  ...
  var evaluate_alarms = function()
  {
    ...
    if(fdisp(in_alarm_max_pressure,0)             > 38.1 || fdisp(in_alarm_max_pressure,0)             < 25.9) { console.log("pressure alarm max"); return false; }
    if(fdisp(in_alarm_min_pressure,0)             > 20.1 || fdisp(in_alarm_min_pressure,0)             < 13.9) { console.log("pressure alarm min"); return false; }
    
    if(fdisp(in_alarm_max_rate,0)                 > 30.1 || fdisp(in_alarm_max_rate,0)                 < 19.9) { console.log("rate alarm max");     return false; }
    if(fdisp(in_alarm_min_rate,0)                 > 12.1 || fdisp(in_alarm_min_rate,0)                 <  5.9) { console.log("rate alarm min");     return false; }
    
    if(fdisp(in_alarm_max_exhale_minute_volume,1) > 12.1 || fdisp(in_alarm_max_exhale_minute_volume,1) < 7.9) { console.log("emv alarm max");      return false; }
    if(fdisp(in_alarm_min_exhale_minute_volume,1) >  6.1 || fdisp(in_alarm_min_exhale_minute_volume,1) <  1.9) { console.log("emv alarm min");      return false; }
